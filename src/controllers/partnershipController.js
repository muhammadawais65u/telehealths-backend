...
export const updatePartnership = async (req, res) => {
  try {
    ...
    await partnership.update({
      ...
      ctaSecondaryLabel,
      ctaSecondaryUrl,
      challengeTitle: challengeTitle ?? partnership.challengeTitle,
      challengeIntro,
      challengePoints: parseJsonField(challengePoints) ?? partnership.challengePoints,
      solutionTitle: solutionTitle ?? partnership.solutionTitle,
      solutionIntro,
      ...
      scalabilityTitle: scalabilityTitle ?? partnership.scalabilityTitle,
      partnersGetTitle: partnersGetTitle ?? partnership.partnersGetTitle,
